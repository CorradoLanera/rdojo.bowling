...
The goal of rdojo.bowling is to ...

## Installation

You can install the released version of rdojo.bowling from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("rdojo.bowling")
```
